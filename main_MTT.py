    ...
    for it in range(0, args.Iteration+1):
        ...
        if it in eval_it_pool:
            for model_eval in model_eval_pool:
                ...
                print('Accuracy/{}'.format(acc_test_mean))
                print('Max_Accuracy/{}'.format(best_acc[model_eval]))
                print('Std/{}'.format(acc_test_std))
                print('Max_Std/{}'.format(best_std[model_eval]))
        ...
        # print({"Synthetic_LR": syn_lr.detach().cpu()}, step=it)
        print("Synthetic_LR:"+str(syn_lr.detach().item()))
        ...
        print({"Grand_Loss": grand_loss.detach().item(), "Start_Epoch": start_epoch})
