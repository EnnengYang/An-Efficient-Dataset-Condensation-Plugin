...
def get_loops(ipc):
    ...
    if ipc == 1:
        ...
        outer_loop, inner_loop = 1, 1
    elif ipc == 8: # Only LoRa
        outer_loop, inner_loop = 1, 1
    elif ipc == 10:
        outer_loop, inner_loop = 10, 50
    elif ipc == 20: # Only LoRa
        outer_loop, inner_loop = 10, 50
    elif ipc == 70: # Only LoRa
        outer_loop, inner_loop = 10, 50
    elif ipc == 80: # Only LoRa
        outer_loop, inner_loop = 10, 50
    elif ipc == 20:
        outer_loop, inner_loop = 20, 25
    elif ipc == 160: # Only LoRa
        outer_loop, inner_loop = 20, 25
    elif ipc == 30:
    ...
    elif ipc == 88: # Only LoRa mnist
        outer_loop, inner_loop = 50, 10
    elif ipc == 100: # Only LoRa mnist
        outer_loop, inner_loop = 50, 10
    elif ipc == 400: # Only LoRa
        outer_loop, inner_loop = 50, 10
