...
def main():
    ...
    args.save_path += args.dataset +'/' + 'DC_' + str(args.ipc) + "ipc" + '/' + str(str_time) + '/'
    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            if it in eval_it_pool:
                ...
                ''' visualize and save '''
                save_name = os.path.join(args.save_path, 'dc_vis_%s_%s_%s_%dipc_exp%d_iter%d.png'%(args.method, args.dataset, args.model, args.ipc, exp, it))
